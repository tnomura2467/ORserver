...
from detect_object.msg import rescustom    #import msg/rescustom.msg
...
class image_converter:
    def __init__(self, input_topic, output_topic, detect_object_service, label_format):
        ...
        self.YoloPub=rospy.Publisher("tounity",rescustom,queue_size=10)  
    ...
    def callback(self, data):
        try:
            ...
            resdata=rescustom() #resdata type -> rescustom
