...
from detect_object.msg import rescustom
...
class image_converter:
    def __init__(self, input_topic, output_topic, detect_object_service, label_format):
        ...
        self.strpub=rospy.Publisher("tounitystr",std_msgs.msg.String,queue_size=10)
    ...
    def callback(self, data):
        try:
            ...
            StrRes=std_msgs.msg.String()
            StrRes.data=str(res.names)
            """resdata=rescustom()
